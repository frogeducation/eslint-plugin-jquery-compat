...
ruleTester.run(
  ...
  rules['jmvc/no-trailing-comma-after-selector'],
  {
    valid: [
      {
        code: '$.Controller("MyController", {}, { "div.ok click": function() {} })',
      },
      {
        code: '$.Controller("MyController", {}, { "div.ok,div.stillok click": function() {} })',
      },
      {
        code: '$.Controller("MyController", {}, { "div.ok, div.stillok click": function() {} })',
      },
    ...
    invalid: [
      ...
      {
        code: '$.Controller("MyController", {}, { \'div.ok,div.notok, click\': function() {} })',
        errors: [
          {
            messageId: 'no-trailing-comma-after-selector',
            line: 1,
      ...
      {
        code: '$.Controller("MyController", {}, { "div.notok, {click}": function() {} })',
        errors: [
          {
            messageId: 'no-trailing-comma-after-selector',
            line: 1,
      ...
      {
        code: '$.Controller("MyController", {}, { "div.notok, div.not, {click}": function() {} })',
        errors: [
          {
            messageId: 'no-trailing-comma-after-selector',
            line: 1,
